                            ...
                            <form action="{{route('services.store')}}" class="mt-2" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-12">
                                        <div class="mb-2">
                                            <input type="text" name="title" class="h-input" placeholder="Название Услуги" value="{{$services->title}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="mb-2">
                                            <input type="text" name="price_id" class="h-input" placeholder="Цена" value="{{$services->price_id}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="mb-2">
                                            <textarea class="form-control" name="text" id="editor1" cols="30" rows="10">{{$services->text}}</textarea>
                                        </div>
                                    </div>
                                </div>
